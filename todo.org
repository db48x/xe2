...
*** Soccer example
** TODO fix having to move off the vehicle before death from decompression occurs
** TODO [#C] drop turrets for additional defense
** TODO [#B] remove no-derivs clause from CC license
