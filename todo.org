...
* Tasks
** FEATURE [#A] drop bombs and trigger			  :blast:
** FEATURE [#A] transparent bomb			  :blast:
** FEATURE [#A] destructible, thinner/different colored enemy trails :blast:
...
** BUG [#A] prevent corner clumping			  :blast:
