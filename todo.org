...
** TODO exit edge
** TODO pager widget / window manager thingy
** TODO make nebula more fun... digging clouds looking for ice
** TODO make distinct keyed ships
** TODO exploding oxygen tanks release ice
** TODO f1 for help, f2 for viewport
** TODO PORT TEXTBOX WIDGET
