...
** TODO fix being able to enter vehicle while in vehicle!
** TODO fix not being able to exit
** TODO rear southwest/southeast firing gun upgrade on Vomac corridors
