...
** TODO dude status display
      ;; TODO print whether or not player is in vehicle
      ;; 

** TODO tell player whether it is safe to eva
** TODO Conditions
** TODO poison from toxic hazards
** TODO tox hypo
** TODO review unused pngs
** TODO Change hive to greenish bg color? or brown
...
** TODO jump to gravity boot walls like in dead space
