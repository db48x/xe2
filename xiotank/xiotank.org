...
** TODO [#B] some kind of powerup or something in rooms
** TODO [#B] some semblance of corridor structure
** TODO [#A] red/green tone sounding *notes* display
** TODO [#C] backgound texture shading?
** TODO [#B] audio UI, sequencer notes are tile objects, the grid is THE grid of the sequence
** TODO [#B] vertical line sweeps across playfield
** TODO Wishlist
