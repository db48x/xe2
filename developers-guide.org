...
This document explains the XE2 engine's general design and programming
interface from the game developer's perspective, and is meant to
assist in writing XE2 game modules.
...
Features in the process of being ported
